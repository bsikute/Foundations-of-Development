...
1. [Reference Guide - GIT, Docker, PowerShell and Bash](https://github.com/bsikute/Foundations-of-Development/blob/Reference-Guide/README.md#reference-guide---git-docker-powershell-and-bash)
     ...
     4. [Bash](https://github.com/bsikute/Foundations-of-Development/blob/Reference-Guide/README.md#bash)
2. [Virtualization vs Containerization](https://github.com/bsikute/Foundations-of-Development/blob/blog-post/README.md#virtualization-vs-containerization)
3. [GitFlow with GIT and Github ](https://github.com/bsikute/Foundations-of-Development/blob/tutorial/README.md#gitflow-with-git-and-github)
